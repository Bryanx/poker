...
public class PublicRoomOverviewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overview_public);
    ...
    public void getRooms() {
        Observable<List<Room>> roomObs = roomService.getRooms().observeOn(AndroidSchedulers.mainThread());
        ...
        compositeDisposable.add(roomObs
                ...
                .subscribe(this::initializeAdapter, error -> {
                    ...
                    Log.e("PublicRoomOverviewActivity", error.getMessage());
                }));
    }
